                ...
                child: AspectRatio(
                  ...
                  child: OverflowBox(
                    ...
                    child: FittedBox(
                      ...
                      child: SizedBox(
                        width: size.width,
                        height: size.width * (cameraController.value.deviceOrientation == DeviceOrientation.landscapeLeft || cameraController.value.deviceOrientation == DeviceOrientation.landscapeRight ? 1 / cameraController.value.aspectRatio : cameraController.value.aspectRatio),
                        child: Stack(
                          fit: StackFit.expand,
                          children: <Widget>[
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (widget.showCaptureControl) ...[const SizedBox(width: 15), _captureControlWidget(value), const SizedBox(width: 15)],
